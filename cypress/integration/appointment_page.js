...
describe("Hillarys Appointment Page Test", function() {
  ...
  it(`Successfully completes form on IE site`, function() {
    cy.visitIE("/arrange-an-appointment/");
    ...
    cy.get("#emailAddress").type("apache@codecomputerlove.com");
    cy.get("#ConfirmEmailAddress").type("apache@codecomputerlove.com");
    cy.get("#telephone").type("0209168046");
    ...
    cy.url().should(
      "eq",
      "https://www.dev.hillarys.ie.hblonline.co.uk/arrange-an-appointment/confirmation/"
    );
  });
